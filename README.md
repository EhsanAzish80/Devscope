...
```
Devscope: A · Low risk · Moderate onboarding · 1.45 tests · 0.66s ⚡
```

### [django](https://github.com/django/django)

```
Devscope: B · Low risk · Hard onboarding · 2.80 tests · 1.21s ⚡
```

### [typer](https://github.com/tiangolo/typer)

```
Devscope: A · Low risk · Moderate onboarding · 0.96 tests · 0.09s ⚡
```

### [requests](https://github.com/psf/requests)

```
Devscope: B · Low risk · Easy onboarding · 1.91 tests · 0.05s ⚡
```
